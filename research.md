...
**Welfare Effects of Resale Price Maintenance: Evidence from the Chinese Pharmaceutical Industry** (JMP, draft coming soon)

> This paper studies how resale price maintenance (RPM), a vertical contract that allows upstream manufacturers to directly control downstream retail prices, affects firm competition and social welfare. RPM is controversial from a regulatory perspective since it can eliminate double markup but facilitate downstream collusion. Exploiting a quasi-natural experiment of a government investigation against a leading pharmaceutical manufacturer on its RPM behavior and a novel pharmacy-level dataset, I document patterns supporting that the manufacturer successfully implemented RPM. A difference-in-differences method shows that by adopting the RPM, the manufacturer decreases its products' average retail prices by 5% while increasing the wholesale prices by 4%, therefore likely to be welfare-improving. Motivated by these findings, I estimated a structural model. I quantify the welfare gains of RPM in this context and illustrate how the key market primitives (consumer substitution patterns and vertical bargaining power) interact with RPM and the policy implications. Counterfactual exercises show that consumer welfare would have been 77% higher had the downstream collusion incentives been muted. In addition, RPM initiated by a more dominant upstream brand can also lead to anti-competitive outcomes.
...
<details><summary markdown="span"> <strong> External Effects of Procurement Auctions: Evidence from Chinese Centralized Procurement for Drugs</strong> </summary>
